...
"
              ...
              >
                ...
                {/* Overlay image */}
                <img
                  src="https://res.cloudinary.com/dauhchstc/image/upload/v1766388927/fullimg2_vubuj6.png"
                  className="absolute inset-0 h-full w-full object-contain"
                  style={{ opacity: progress }}
                  alt=""
                />
      ...
      <div id="signup-form" className="h-screen w-full bg-gray-100 flex flex-col items-center justify-center">
        {showSignupLoading ? <form onSubmit={handleSignup} className="p-8 max-w-sm mx-auto">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-3 py-2 rounded-lg bg-black text-white hover:bg-gray-700 transition-colors text-sm disabled:opacity-50"
          >
