...
export default function DashboardPage() {
  ...
  const buyCreditsBtnRef = useRef<HTMLButtonElement | null>(null)
  ...
  "
          >
            <img
              className="absolute left-10 w-5 h-5 opacity-70"
              src="/svg/coins.svg"
              alt="credits"
            />
  ...
  "
          >
            <img className="absolute left-10 w-5 h-5" src="/svg/group.svg" alt="settings" />
                ...
                {!submitted ? (
                  <>
                    ...
                    <p className="text-sm text-gray-500 mb-4">
                      {feedbackType === "bug" ? "Short and specific is best." : "Describe what you're thinking - no limits!"}
